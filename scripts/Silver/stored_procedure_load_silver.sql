...
Notes:
    - Silver tables are truncated before loading.
    - Source data is read from the Bronze layer.
    - Load duration and errors are logged using PRINT statements.
================================================================================
*/
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '   - Total Load Duration: ' + CAST(DATEDIFF(MILLISECOND, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' seconds';
		PRINT '=========================================='
